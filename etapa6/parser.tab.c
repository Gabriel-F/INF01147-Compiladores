...
{
       0,   127,   127,   135,   138,   143,   144,   145,   158,   159,
     160,   161,   163,   165,   166,   167,   168,   170,   171,   172,
     173,   174,   184,   206,   206,   207,   207,   208,   208,   209,
     211,   213,   213,   214,   219,   234,   236,   237,   238,   239,
     240,   241,   242,   244,   245,   246,   247,   248,   253,   255,
     255,   274,   274,   276,   302,   305,   306,   309,   310,   312,
     325,   339,   347,   353,   373,   374,   379,   381,   386,   388,
     393,   398,   401,   407,   413,   419,   426,   428,   437,   446,
     448,   449,   458,   467,   469,   474,   487,   489,   489,   489,
     491,   491,   493,   493,   493,   495,   509,   515,   515
};
#endif
...
#line 127 "parser.y"
                             { arvore = (yyval.no);  
                               pop(stack);
                               char fullCode[10000];
                               strcpy(fullCode,initializeRegisters((yyval.no)->code));
                               strcat(fullCode,jumpToMain(mainLabel));
                               strcat(fullCode,(yyval.no)->code);
                               strcat(fullCode,"halt\n");
...
#line 325 "parser.y"
      ...
      }else if((yyvsp[-3].no) == NULL && (yyvsp[0].no) != NULL){
      ...
      }else if((yyvsp[0].no) == NULL && (yyvsp[-3].no) != NULL){
